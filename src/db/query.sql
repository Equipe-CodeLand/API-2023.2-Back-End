...
## Select para fazer o painel de chamadas (Visão do atendente ou administrador)
select user_nome,user_sobrenome,cha_tema,sta_nome,pri_nome,cha_inicio,user_email,cha_desc from usuario u
...
select user_nome,user_sobrenome,cha_tema,sta_nome,pri_nome,cha_inicio,cha_desc from usuario u
